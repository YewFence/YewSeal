...
func clearCLIEnvironment(t *testing.T) {
	...
	for _, name := range []string{
		"YEWSEAL_KEY_FILE",
		"YEWSEAL_INIT_FORCE", "YEWSEAL_INIT_INPUT", "YEWSEAL_INIT_OUTPUT", "YEWSEAL_INIT_FORMAT", "YEWSEAL_INIT_CREATE_EXAMPLE", "YEWSEAL_INIT_SYNC_SOPS_CONFIG", "YEWSEAL_INIT_JSON",
		"YEWSEAL_ENCRYPT_OUTPUT", "YEWSEAL_ENCRYPT_PARALLEL", "YEWSEAL_ENCRYPT_FORCE", "YEWSEAL_ENCRYPT_VERBOSE", "YEWSEAL_ENCRYPT_JSON",
		"YEWSEAL_DECRYPT_OUTPUT", "YEWSEAL_DECRYPT_PARALLEL", "YEWSEAL_DECRYPT_FORCE", "YEWSEAL_DECRYPT_STRICT", "YEWSEAL_DECRYPT_VERBOSE", "YEWSEAL_DECRYPT_JSON",
		"YEWSEAL_PLAN_VERBOSE", "YEWSEAL_PLAN_JSON", "YEWSEAL_EDIT_FILE", "YEWSEAL_VIEW_VERBOSE", "YEWSEAL_VIEW_JSON", "YEWSEAL_DIFF_COLOR", "YEWSEAL_DIFF_VERBOSE", "YEWSEAL_DIFF_JSON",
		"YEWSEAL_AGE_IDENTITIES", "YEWSEAL_FORMAT", "SOPS_FORMAT",
	} {
		t.Setenv(name, "")
