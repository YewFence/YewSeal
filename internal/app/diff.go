...
func DiffPlaintextAgainstEncryptedTargets(w, diagnostics io.Writer, cfg *config.Config, target, keyFile string, verbose bool, colorMode string, strict bool) (comparison DiffResult, err error) {
